...
class GraphTransformer(nn.Module):
    def __init__(
        ...
        self.fusion_classifier = nn.Linear(out_channels + bert_feature_dim, num_classes)

        self.structure_proj = ProjectionHead(out_channels, projection_dim, dropout)
        self.sequence_proj = ProjectionHead(bert_feature_dim, projection_dim, dropout)
        self.fused_proj = ProjectionHead(out_channels + bert_feature_dim, projection_dim, dropout)
